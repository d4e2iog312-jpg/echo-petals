...
const TRACKS = [
  { title: "505", artist: "Arctic Monkeys", src: "/assets/505-arctic-monkeys.mp3" },
  { title: "Último baile", artist: "Chachacha", src: "/assets/chachacha.mp3" },
  { title: "My One and Only Love", artist: "Para Key", src: "/assets/my-one-and-only-love.mp3" },
];
